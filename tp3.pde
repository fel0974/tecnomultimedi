...
textFont(let2);
textSize(24);
text("No es una buena idea",400,20);
...
fill(255);
textSize(24);
text("No parece ser muy util",400,260);
...
fill(255);
textSize(24);
text("¡Muchas gracias por Probarlo!",400,260);
fill(0,150);
rect(230,565,340,25);
fill(255);
textSize(18);
...
text("presiona 'BACKSPACE' para volver al inicio",400,490);
for ( int i = 0; i < cant ; i++ ) {
y[i] += v[i];
if ( y[i] > height ) {
x[i] = random( width );
